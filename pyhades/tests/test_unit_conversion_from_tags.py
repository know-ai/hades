...
class TestUnitConversionFromTags(unittest.TestCase):
    ...
    def testLengthUnitConversion(self):
        ...
        self.tag_engine.set_tag(*_tag)
        value = 10
        self.tag_engine.write_tag(tag_name, value)

        new_value = self.tag_engine.read_tag(tag_name, unit='cm')
        self.assertAlmostEqual(new_value, 1000.0, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='m')
        self.assertAlmostEqual(new_value, 10.0, 5)
        
        new_value = self.tag_engine.read_tag(tag_name, unit='in')
        self.assertAlmostEqual(new_value, 393.7008, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='ft')
        self.assertAlmostEqual(new_value, 32.8084, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='yd')
        self.assertAlmostEqual(new_value, 10.936130, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='km')
        self.assertAlmostEqual(new_value, 0.01, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='mi')
    ...
    def testAreaUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='in2')
        self.assertAlmostEqual(new_value, 15500.03, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='ft2')
    ...
    def testVolumeUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='lt')
        self.assertAlmostEqual(new_value, 10000.0, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='US brl')
        self.assertAlmostEqual(new_value, 62.8981, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='ft3')
        self.assertAlmostEqual(new_value, 353.147, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='US gal')
    ...
    def testMassUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='kg')
        self.assertAlmostEqual(new_value, 1.0, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='tonne')
        self.assertAlmostEqual(new_value, 10 ** -3, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='lb')
        self.assertAlmostEqual(new_value, 2.20462, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='oz')
    ...
    def testDensityUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='kg/m3')
        self.assertAlmostEqual(new_value, 1000, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='lb/ft3')
        self.assertAlmostEqual(new_value, 62.42197, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='lb/in3')
    ...
    def testVolumetricLiquidFlowUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='lt/h')
        self.assertAlmostEqual(new_value, 3.6 * 10 ** 6, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='m3/s')
        self.assertAlmostEqual(new_value, 1.0, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='m3/min')
        self.assertAlmostEqual(new_value, 60, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='ft3/min')
        self.assertAlmostEqual(new_value, 2119.093, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='US brl/d')
    ...
    def testVolumetricGasFlowUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='Std. ft3/h')
        self.assertAlmostEqual(new_value, 35.31073, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='Std. ft3/min')
    ...
    def testMassFlowUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='kg/s')
        self.assertAlmostEqual(new_value, 1000 / (60 * 60), 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='kg/min')
        self.assertAlmostEqual(new_value, 1000 / 60, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='lb/h')
        self.assertAlmostEqual(new_value, 2204.586, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='tonne/h')
        self.assertAlmostEqual(new_value, 1.0, 5)
    ...
    def testMolarFlowUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='kmole/min')
        self.assertAlmostEqual(new_value, 1000 / 60, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='kmole/s')
    ...
    def testPressuresUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='MPa')
        self.assertAlmostEqual(new_value, 1.0, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='inH2O')
        self.assertAlmostEqual(new_value, 4014.4523761, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='bar')
        self.assertAlmostEqual(new_value, 10.0, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='mmHg')
        self.assertAlmostEqual(new_value, 7500.2, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='atm')
    ...
    def testSpeedUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='m/min')
        self.assertAlmostEqual(new_value, 60, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='ft/s')
        self.assertAlmostEqual(new_value, 3.28084, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='km/h')
        self.assertAlmostEqual(new_value, 3.6, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='mi/h')
    ...
    def testDynamicViscosityUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='poise')
        self.assertAlmostEqual(new_value, 10.0, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='lb/(ft.s)')
    ...
    def testKinematicViscosityUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='cs')
        self.assertAlmostEqual(new_value, 1000.0, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='ft2/s')
        self.assertAlmostEqual(new_value, 0.010763915, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='m2/s')
    ...
    def testTemperatureUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='K')
        self.assertAlmostEqual(new_value, 573.15, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='ªF')
        self.assertAlmostEqual(new_value, 572, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='R')
    ...
    def testTimeUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='h')
        self.assertAlmostEqual(new_value, 24, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='s')
        self.assertAlmostEqual(new_value, 24 * 3600, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='min')
    ...
    def testConductivityUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='BTU.in/(h.ft2.ªF)')
    ...
    def testEnergyUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='N.m')
        self.assertAlmostEqual(new_value, 1.0, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='erg')
        self.assertAlmostEqual(new_value, 10 ** 7, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='cal')
        self.assertAlmostEqual(new_value, 0.2390057361, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='kWh')
        self.assertAlmostEqual(new_value, 2.778 * 10 ** -7, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='BTU')
    ...
    def testPowerUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='J/s')
        self.assertAlmostEqual(new_value, 1.0, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='cal/s')
        self.assertAlmostEqual(new_value, 0.2390057361, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='BTU/s')
        self.assertAlmostEqual(new_value, 9.478133944988911 * 10 ** -4, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='hp')
    ...
    def testAccelerationUnitConversion(self):
        ...
        new_value = self.tag_engine.read_tag(tag_name, unit='in/s2')
        self.assertAlmostEqual(new_value, 39.37008, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='ft/s2')
        self.assertAlmostEqual(new_value, 3.280839895, 5)

        new_value = self.tag_engine.read_tag(tag_name, unit='mi/s2')
