...
The variables are simulate with an OPC UA Server Simulator like [Prosys OPC UA](https://www.prosysopc.com/products/opc-ua-simulation-server/)

The OPC UA communication with the OPC UA Server is made with [Pronode OPC UA Client](https://hub.docker.com/r/knowai/pronode_opcua_client)
version 1.0.2
